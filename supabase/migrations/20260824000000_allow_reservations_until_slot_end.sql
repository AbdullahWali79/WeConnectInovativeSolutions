...
begin
  ...
  if exists (
    select 1
    from public.seat_holiday_closures
  ...
  -- Slot dates and times are entered in Pakistan time. Allow students to
  -- reserve during an active slot, but reject the reservation after it ends.
