...
const navGroups: NavGroup[] = [
  { id: "academics", label: "Academics", icon: "school", items: [
    ...
    { href: "/admin/project-submissions", label: "Project Submissions", icon: "upload_file", adminOnly: true },
    ...
    { href: "/admin/simulations", label: "Simulations", icon: "science", adminOnly: true },
  ]},
