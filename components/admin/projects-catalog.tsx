    ...
    <div>
      ...
      {bundles.length === 0 ? (
        <section className="rounded-xl border border-dashed border-outline-variant bg-surface-low p-10 text-center">
          <Icon name="assignment" className="text-5xl text-on-surface-variant" />
          <h2 className="mt-4 text-xl font-bold">No active courses found</h2>
          <p className="mt-2 text-sm text-on-surface-variant">There are no courses to assign projects to.</p>
        </section>
      ) : (
