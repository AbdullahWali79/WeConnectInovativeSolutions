  ...
  return <div className="space-y-6">
    ...
    <form onSubmit={save} className="wc-card space-y-5 p-5 md:p-6">
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <label><span className="wc-label">Model</span><input className="wc-input mt-2" value={form.model} onChange={(event) => setForm({ ...form, model: event.target.value })} placeholder="gemini-flash-latest" /></label>
