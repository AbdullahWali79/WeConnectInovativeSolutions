...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[var(--wc-bg)] text-on-surface px-5 py-8 md:px-margin-page relative overflow-hidden flex items-center justify-center">
      <style>{`body { background-color: var(--wc-bg) !important; }`}</style>
        ...
        <section className="rounded-3xl border border-[var(--wc-outline-variant)] bg-[var(--wc-surface-lowest)]/60 p-6 shadow-[0_0_50px_rgba(0,0,0,0.5)] backdrop-blur-xl md:p-10">
          <form onSubmit={submit} className="space-y-6">
            ...
            <label className="block">
              ...
              <input value={form.email} onChange={(event) => updateField("email", event.target.value)} className="w-full rounded-xl border border-[var(--wc-outline-variant)] bg-black/20 px-5 py-4 text-on-surface placeholder-[#5B6B88] focus:border-[var(--wc-secondary)] focus:outline-none focus:ring-1 focus:ring-[var(--wc-secondary)] transition-all" type="email" autoComplete="email" placeholder="you@example.com" required />
            </label>
            ...
            <label className="block">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-[var(--wc-outline-variant)] bg-black/20 px-5 py-4 text-on-surface placeholder-[#5B6B88] focus:border-[var(--wc-secondary)] focus:outline-none focus:ring-1 focus:ring-[var(--wc-secondary)] transition-all pr-12"
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-[var(--wc-on-surface-variant)] hover:text-[var(--wc-secondary)] transition-colors"
                  tabIndex={-1}
                >
