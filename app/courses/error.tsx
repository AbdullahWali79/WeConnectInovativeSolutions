  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[linear-gradient(180deg,var(--wc-surface-lowest)_0%,var(--wc-surface)_100%)] px-5 py-16">
      <div className="max-w-xl rounded-2xl border border-[#DDE6F5] bg-white p-8 text-center shadow-card">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[#EEF4FF] text-[#062B7F]">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
          <button onClick={reset} className="inline-flex items-center justify-center rounded-lg bg-[#062B7F] px-5 py-3 font-bold text-white shadow-sm hover:shadow-md">
            Retry
          </button>
          <Link href="/" className="inline-flex items-center justify-center rounded-lg border border-[#DDE6F5] px-5 py-3 font-bold text-[#062B7F] hover:bg-[#EEF4FF]">
            Back Home
          </Link>
        </div>
      </div>
